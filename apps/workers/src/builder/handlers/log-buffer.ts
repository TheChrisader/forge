/**
 * Log Buffer - Memory-bounded buffering for build logs
 *
 ...
 * builds by enforcing maximum buffer capacity.
 *
 * @module log-buffer
 */
 ...
 *
 * // Add entries
 * buffer.push({ deploymentId, lineNumber: 1, timestamp: new Date(), level: "INFO", message: "test", source: "BUILD" });
 *
 * // Check utilization
