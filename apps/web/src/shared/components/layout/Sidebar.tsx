...
import { Home, Folder, Server, Activity, BarChart3, Bell, Settings, Package } from "lucide-react";
  ...
  return (
    <aside className="flex w-64 flex-col bg-card border-r border-border">
      <div className="h-20 flex items-end px-5 pb-3 border-b border-border/50">
        <h1 className="font-serif text-4xl font-bold tracking-tight text-foreground">F</h1>
        <div className="mb-1.5 ml-1.5 flex flex-col">
          <span className="font-serif text-sm font-semibold tracking-wide text-foreground/90">
            orge
          </span>
      ...
      <nav className="flex-1 px-4 py-8">
        <div className="space-y-6">
          {navigation.map((item) => (
            ...
            >
              <span className="font-mono text-[10px] text-muted-foreground/40 w-5 tabular-nums group-[.active]:text-primary">
              ...
              <span className="font-sans text-sm tracking-wide text-muted-foreground transition-colors group-hover:text-foreground group-[.active]:text-primary group-[.active]:font-bold">
                {item.name}
              </span>
      ...
      <div className="border-t border-border/50 px-5 py-4">
        <div className="flex items-baseline justify-between">
          <div className="flex flex-col gap-0.5">
            ...
            <span className="font-sans text-xs text-foreground/80">Operational</span>
          </div>
          <div className="text-right">
            <span className="font-mono text-[10px] text-muted-foreground/40">v0.1.0</span>
          </div>
        </div>
      </div>
    </aside>
