export const SERVICE_KEYS = {
  ...
  ALERT_SERVICE: Symbol.for("forge:alert-service"),
  ALERT_RULE_SERVICE: Symbol.for("forge:alert-rule-service"),
  ALERT_CHANNEL_SERVICE: Symbol.for("forge:alert-channel-service"),
  SECRET_SERVICE: Symbol.for("forge:secret-service"),
  ENVIRONMENT_VARIABLE_SERVICE: Symbol.for("forge:environment-variable-service"),
