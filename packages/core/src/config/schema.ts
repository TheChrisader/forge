...
export const ProxyConfigSchema = z.object({
  ...
  ssl: z.object({
    enabled: z.boolean().default(true),
    mode: z.enum(["letsencrypt", "selfsigned"]).default("selfsigned"),
    autoGenerate: z.boolean().default(true),
    email: z.email().optional(),
    certPath: z.string().default("./data/certs"),
    caCertFile: z.string().default("ca.crt"),
    certFile: z.string().default("cert.crt"),
    keyFile: z.string().default("cert.key"),
  }),
